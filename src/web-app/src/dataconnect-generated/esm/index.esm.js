...
export const updateDailyGoalsRef = (dcOrVars, vars) => {
...
export function updateDailyGoals(dcOrVars, vars) {
  return executeMutation(updateDailyGoalsRef(dcOrVars, vars));
}

export const listLogEntriesRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
...
export function listLogEntries(dc) {
